function [] = first_level_3D(resultsdir,units,TR,data,N,matfile,mask)
...
% ------
%
% resultsdir    - string representing path where results will be written to.
%
...
for i = 1:N
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess.scans{i,1} = [data(1:end-5),ZeroPad,num2str(i),'.nii'];
    
end

matlabbatch{1}.spm.stats.fmri_spec.dir = {resultsdir};
...
% run estimation
matlabbatch{2}.spm.stats.fmri_est.spmmat = {[resultsdir,'SPM.mat']};
